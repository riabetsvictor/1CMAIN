...
// Функция - Получить состояния формы
...
//		]
//			
Функция ПолучитьСостоянияФормы(ПутьКФайлуТекущейОбработки,ИмяФайлаТекущейОбработки,ИмяФормы) Экспорт
...
//											по ключу "СостоянияЭлементов". Саму струтуру можно получить методом ПолучитьСостоянияФормы.
//  МассивСостоянийРеквизитовФормы	 -	 Массив состояний реквизитов формы . М.б. получен из структуры, описывающей состояние формы,
//											по ключу "СостоянияРеквизитов". Саму струтуру можно получить методом ПолучитьСостоянияФормы.
...
// Процедура - Сохранить состояние формы
...
//
Процедура СохранитьСостояниеФормы(ПутьКФайлуТекущейОбработки,ИмяФайлаТекущейОбработки,ИмяФормы,
...
Процедура СохранитьПризнакИспПоУмол(ПутьКФайлуТекущейОбработки,ИмяФайлаТекущейОбработки,ИмяФормы,
...
Процедура УдалитьСостояниеФормы(ПутьКФайлуТекущейОбработки,ИмяФайлаТекущейОбработки,ИмяФормы,	ИмяСостояния) Экспорт
	Попытка
		ФайлНастроек=Новый Файл(ПутьКФайлуТекущейОбработки+"GroupChangesSettings"+ИмяФайлаТекущейОбработки+".xml");	
		Если Не ФайлНастроек.Существует() Тогда Возврат ;КонецЕсли;
